...
#ifndef KSL_CHARTENGINE_H
#define KSL_CHARTENGINE_H
...
public:
    ...
    ChartEngine(const QString &name="Ksl", QObject *parent=0);
...
signals:
    ...
    void errorOccurred(ChartEngine *self);

    void changed(ChartEngine *self);
...
protected:
    ...
    ChartEngine(Ksl::ObjectPrivate *priv, QObject *parent)
        : QObject(parent)
        , Ksl::Object(priv)
    { }
};
